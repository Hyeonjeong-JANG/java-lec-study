...
public class BankApp {
    public static void main(String[] args) {
        ...
        // 2. 계좌 2개 만들기
        Account ssarAccount = new Account(1111, 10000L, 1);// balance는 long 타입이기 때문에 L을 붙임.
        Account cosAccount = new Account(2222, 10000L, 2);
        Account loveAccount = new Account(3333, 10000L, 3);
